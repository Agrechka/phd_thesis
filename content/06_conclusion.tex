...
\todo{talk about how research papers don't necessarily extend to real-world applications. we have 
to adapt them quite a bit.}

As I look at my 5-month old son right now, I cannot help but wonder, "Can we program a machine to behave like him?". \note{insert 
the ai experiment from netflix babies where they tried to make the robots as curious as possible}. We have achieved massive progress 
