...
% \cite{meng2022sdedit} show that by drawing strokes on an input image and then noising and denoising with the \ac{DDPM}, we can 
% obtain realistic images incorporating the stroke into the domain of the pre-trained \ac{DDPM}. However, fidelity to the 
% input image is not guaranteed, since the parts of the input image which have been noised are irrecoverable. 

Here, we aimed at acheiving a very general image-editing task: inpainting.
...
\todo{Our work is a ... arxiv submission}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.8\linewidth]{images/gradpaint/imagenet_results.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/gradpaint/ThinMasks.pdf}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.95\linewidth]{images/gradpaint/CVPR_ffhq.jpeg}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.6\linewidth]{images/gradpaint/uncur1.jpeg}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.6\linewidth]{images/gradpaint/uncur2.pdf}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.6\linewidth]{images/gradpaint/uncur3.jpeg}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.6\linewidth]{images/gradpaint/uncur4.pdf}
...
\section{Inference Time Study}\label{speed_section}
